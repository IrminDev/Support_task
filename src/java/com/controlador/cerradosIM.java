...
@WebServlet(name = "cerradosIM", urlPatterns = {"/cerradosIM"})
public class cerradosIM extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
         ...
         response.setContentType("text/plain");
                  ...
                  List<Reporte> lista = new IMDao().listarReportes();
                  String output = "";
                  int size = lista.size();
                  ...
                  for(int i=0; i<size; i++){
                    ...
                    output +=""+ 
                            "<div class=\"unidad\" >\n" +
                              ...
                              "</div>\n"+
                              "</div>"+
                            "<a href=\"../../../addRepoteFaqIM?id=" + lista.get(i).getIdReporte() +"\">Agregar FAQ</a>\n";
