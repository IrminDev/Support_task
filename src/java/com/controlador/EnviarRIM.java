...
@WebServlet(name = "EnviarRIM", urlPatterns = {"/EnviarRIM"})
public class EnviarRIM extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
          ...
          response.setContentType("text/plain");
                  ...
                  List<Reporte> lista = new IMDao().listarReportesP();
                  String output = "";
                  int size = lista.size();
...
"                    <h2>Estatus</h2>\n" +
 ...
 "<a href=\"../../listaIM?accion=altar&id="+lista.get(i).getIdReporte()+"\"/>\">Solucionar</a>\n" +
"</div>"  ;
                           }
