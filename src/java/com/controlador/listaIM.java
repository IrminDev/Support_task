 ...
 * @author itzelsosa
 */
@WebServlet(name = "listaIM", urlPatterns = {"/listaIM"})
public class listaIM extends HttpServlet {
  String listar="IM/Reportes/feed.jsp";
  String listarC="IM/Reportes/Reportes/feed1.jsp";//cerrados
  String reportes="IM/Reportes/Reportes/feed.jsp";//mantenimiento
  String cerrado ="IM/Reportes/Reportes/cerrado.jsp";
  String add="IM/reportesoporte.jsp";
  String edit="IM/reportesoporte.jsp";
  String faqs="IM/Reportes/FAQS/addFAQ.jsp";
